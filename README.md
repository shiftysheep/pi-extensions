...
| `status-line.ts` | Future-proof working indicator with live and provider-confirmed tok/s rates, plus an async subagent cost widget. | [docs/status-line.md](docs/status-line.md) |
